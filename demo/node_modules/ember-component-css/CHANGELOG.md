...
* **component name parsing:** only switching out the word 'compoent/' if it is what starts the path, not for nest options. This should be revisited with unification Closes [#236](https://github.com/ebryn/ember-component-css/issues/236) ([5d8796d](https://github.com/ebryn/ember-component-css/commit/5d8796d))
